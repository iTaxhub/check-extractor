...
(function () {
      ...
      body.innerHTML = `
        <div style="margin-bottom:12px;">
          ...
          ${isCurrentCompany
            ...
            : currentRealm
              ? '<div style="font-size:10px;color:#d97706;font-weight:600;">⚠ Different company active in Kyriq</div>'
              : ''
          }
        </div>
        <div class="stat-row">
        ...
        <div style="border-top:1px solid #f3f4f6;padding-top:8px;text-align:center;">
          <span style="font-size:9px;color:#d1d5db;">Kyriq v1.0.0 &middot; $300/yr</span>
        </div>
      `;
  ...
  function injectBadges(realmId) {
    ...
    // For now, just mark the page as "Kyriq active"
